...
_T = {
    ...
    "account_count_prompt": {
        "en": "How many accounts to create? (1-50)",
        "ru": "Сколько счетов создать? (1-50)", "zh": "要创建多少个账户？(1-50)",
        "id": "Berapa akun yang dibuat? (1-50)", "ko": "몇 개의 계정을 만들까요? (1-50)",
        "es": "¿Cuántas cuentas crear? (1-50)",
        "nl": "Hoeveel accounts aanmaken? (1-50)",
    },
    "account_basename_prompt": {
        "en": "Base name (optional; accounts numbered 1…N)",
        "ru": "Базовое имя (необязательно; счета нумеруются 1…N)",
        "zh": "基础名称（可选；账户编号 1…N）",
        "id": "Nama dasar (opsional; akun bernomor 1…N)",
        "ko": "기본 이름 (선택 사항; 계정 번호 1…N)",
        "es": "Nombre base (opcional; cuentas numeradas 1…N)",
        "nl": "Basisnaam (optioneel; accounts genummerd 1…N)",
    },
    "invalid_count": {
        "en": "Enter a whole number between 1 and 50.",
        "ru": "Введите целое число от 1 до 50.",
        "zh": "请输入 1 到 50 之间的整数。",
        "id": "Masukkan angka bulat antara 1 dan 50.",
        "ko": "1에서 50 사이의 정수를 입력하세요.",
        "es": "Introduce un número entero entre 1 y 50.",
        "nl": "Voer een geheel getal tussen 1 en 50 in.",
    },
    "accounts_created": {
        "en": "Created {n} account(s).", "ru": "Создано счетов: {n}.",
        "zh": "已创建 {n} 个账户。", "id": "Membuat {n} akun.",
        "ko": "{n}개의 계정을 생성했습니다.", "es": "Se crearon {n} cuenta(s).",
        "nl": "{n} account(s) aangemaakt.",
    },
    "rename_prompt": {
